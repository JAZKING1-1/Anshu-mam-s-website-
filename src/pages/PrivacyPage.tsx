...
export const PrivacyPage = () => (
  <div className="container">
    ...
    <article className="prose legal-content">
      ...
      <p>The Instagram enquiry option prepares a short message about the support you choose. It does not ask for your name or email address. If you choose “Copy message”, the text is copied to your device’s clipboard. Opening Anshu’s profile does not send the message; you decide what to share in Instagram.</p>
      ...
      <p>Instagram and any linked appointment, email or WhatsApp service operate under their own privacy terms. Review those terms before sharing information. An appointment service may ask for additional details needed to arrange a conversation.</p>
      ...
      {CONTACT_CONFIG.email
        ...
        : <p>You can find Anshu’s Instagram profile on the <a className="text-link" data-route href="/contact">contact page</a>.</p>}
    </article>
  </div>
);
