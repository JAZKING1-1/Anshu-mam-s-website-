import { ArrowDown, ArrowUpRight, Flower2, HeartHandshake, Leaf } from 'lucide-react';
    ...
    <section className="hero power-hero" data-scroll-art>
      ...
      <div className="container hero-grid">
        <div className="hero-copy">
          <p className="eyebrow hero-entrance"><span /> MINDSET, LIFE & RELATIONSHIP COACHING FOR WOMEN</p>
          <h1 className="hero-entrance">Soft heart.<br />Strong voice.<br /><em>Your life.</em></h1>
          <p className="hero-description hero-entrance">You can care for others and still choose yourself. Personal coaching with Anshu to explore self-worth, boundaries, and a life that feels like yours.</p>
          <div className="hero-actions hero-entrance"><a href="/coaching" data-route className="button button-light">Explore working with me <ArrowUpRight size={18} /></a><a href="/book?offer=clarity-call" data-route className="text-link">Start with a free Clarity Call <ArrowUpRight size={17} /></a></div>
          <p className="hero-note hero-entrance"><span className="note-line" /> Life by choice, not by chance.</p>
        </div>
      ...
      <div className="container hero-bottom"><span>PERSONAL COACHING · A CONVERSATION TO BEGIN</span><a href="#a-place-for-you"><span className="scroll-cue"><ArrowDown size={15} /></span> A little space to explore</a></div>
    </section>
